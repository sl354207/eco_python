...
del samples_path, obis_path

# %%
inner = pd.merge(samples, obis, how="inner", on=["scientific_name"], indicator=True)
...
# %%
outer = pd.merge(samples, obis, how="outer", on=["scientific_name"], indicator=True)
...
# %%
del frames, left, right, inner, species_unique
